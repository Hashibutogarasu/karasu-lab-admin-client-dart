...
class GalleriesApi {
  ...
  Future<Response<Gallery>> galleriesControllerCreate({ 
    ...
    final _path = r'/wiki/admin/galleries';
  ...
  Future<Response<void>> galleriesControllerDelete({ 
    ...
    final _path = r'/wiki/admin/galleries/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> galleriesControllerUploadFile({ 
    ...
    final _path = r'/wiki/admin/galleries/upload';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
