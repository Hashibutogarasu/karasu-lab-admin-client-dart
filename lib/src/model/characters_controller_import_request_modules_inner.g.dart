...
part of 'characters_controller_import_request_modules_inner.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$CharactersControllerImportRequestModulesInner
    extends CharactersControllerImportRequestModulesInner {
  @override
  final String name;
  @override
  final bool? isPosed;
  @override
  final BuiltList<CharactersControllerImportRequestModulesInnerComponentsInner>?
      components;
  @override
  final String id;
  @override
  ...
  factory _$CharactersControllerImportRequestModulesInner(
          [void Function(CharactersControllerImportRequestModulesInnerBuilder)?
              updates]) =>
      (new CharactersControllerImportRequestModulesInnerBuilder()
            ..update(updates))
          ._build();

  _$CharactersControllerImportRequestModulesInner._(
      {required this.name,
      this.isPosed,
      this.components,
      required this.id,
    ...
    BuiltValueNullFieldError.checkNotNull(
        name, r'CharactersControllerImportRequestModulesInner', 'name');
    BuiltValueNullFieldError.checkNotNull(
        id, r'CharactersControllerImportRequestModulesInner', 'id');
    BuiltValueNullFieldError.checkNotNull(
        desc, r'CharactersControllerImportRequestModulesInner', 'desc');
    BuiltValueNullFieldError.checkNotNull(originModuleId,
        r'CharactersControllerImportRequestModulesInner', 'originModuleId');
  }

  @override
  CharactersControllerImportRequestModulesInner rebuild(
          void Function(CharactersControllerImportRequestModulesInnerBuilder)
              updates) =>
      (toBuilder()..update(updates)).build();

  @override
  CharactersControllerImportRequestModulesInnerBuilder toBuilder() =>
      new CharactersControllerImportRequestModulesInnerBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is CharactersControllerImportRequestModulesInner &&
        name == other.name &&
  ...
  String toString() {
    return (newBuiltValueToStringHelper(
            r'CharactersControllerImportRequestModulesInner')
          ..add('name', name)
          ..add('isPosed', isPosed)
...
class CharactersControllerImportRequestModulesInnerBuilder
    implements
        Builder<CharactersControllerImportRequestModulesInner,
            CharactersControllerImportRequestModulesInnerBuilder> {
  _$CharactersControllerImportRequestModulesInner? _$v;
  ...
  ListBuilder<CharactersControllerImportRequestModulesInnerComponentsInner>?
      _components;
  ListBuilder<CharactersControllerImportRequestModulesInnerComponentsInner>
      get components => _$this._components ??= new ListBuilder<
  ...
  CharactersControllerImportRequestModulesInnerBuilder() {
    CharactersControllerImportRequestModulesInner._defaults(this);
  }

  CharactersControllerImportRequestModulesInnerBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _name = $v.name;
      _isPosed = $v.isPosed;
  ...
  @override
  void replace(CharactersControllerImportRequestModulesInner other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$CharactersControllerImportRequestModulesInner;
  }
  ...
  @override
  CharactersControllerImportRequestModulesInner build() => _build();

  _$CharactersControllerImportRequestModulesInner _build() {
    _$CharactersControllerImportRequestModulesInner _$result;
    try {
      _$result = _$v ??
          new _$CharactersControllerImportRequestModulesInner._(
              name: BuiltValueNullFieldError.checkNotNull(name,
                  r'CharactersControllerImportRequestModulesInner', 'name'),
              isPosed: isPosed,
              ...
              switch_: switch_,
              desc: BuiltValueNullFieldError.checkNotNull(desc,
                  r'CharactersControllerImportRequestModulesInner', 'desc'),
              repeated: repeated,
