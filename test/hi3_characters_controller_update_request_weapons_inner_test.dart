...
// tests for Hi3CharactersControllerUpdateRequestWeaponsInner
void main() {
  final instance = Hi3CharactersControllerUpdateRequestWeaponsInnerBuilder();
  // TODO add properties to the builder and call build()

  group(Hi3CharactersControllerUpdateRequestWeaponsInner, () {
    // String id
    ...
    // num baseAtk
    test('to test the property `baseAtk`', () async {
      // TODO
    });

    // num crit
    test('to test the property `crit`', () async {
      // TODO
    });
