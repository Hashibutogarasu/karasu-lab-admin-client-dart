...
// tests for UpdateCharacterRequestWeapon
void main() {
  final instance = UpdateCharacterRequestWeaponBuilder();
  // TODO add properties to the builder and call build()

  group(UpdateCharacterRequestWeapon, () {
    // String id
    ...
    // UpdateCharacterRequestWeaponVersion version
